...
export default function OverviewFeatureShowcase() {
  ...
  return (
    <FeatureShowcaseMotion className="mt-8 grid min-w-0 items-start gap-6 sm:mt-10 sm:gap-8 lg:mt-12 lg:grid-cols-[minmax(0,1.08fr)_minmax(18rem,0.92fr)] lg:items-center lg:gap-10 xl:gap-12">
